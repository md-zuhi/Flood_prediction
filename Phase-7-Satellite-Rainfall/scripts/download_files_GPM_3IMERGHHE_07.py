...
To run the script: `python download_files_GPM_3IMERGHHE_07.py`
"""
...
def _get_auth():
    try:
        n = netrc.netrc(os.path.join(os.path.expanduser("~"), ".netrc"))
        login, _, password = n.authenticators("urs.earthdata.nasa.gov")
...
VERSION = "07"
FILTER_TEMPORAL = "2026-08-23T00:00:00.000Z,2026-08-24T23:59:59.000Z"
FILTER_BBOX = "76.65,11.2,76.95,11.5"
FILTER_SEARCH = ""
